...
def main():
    ...
    dataset_path = '../../data/data_test_server'

    #trained_models = tf.keras.models.load_model(model_name)
    #àtest_set, _ = ds.load_data(dataset_path, 224, 224, test_split=0, batch_size=32)
    #trained_models.evaluate(test_set)

    #predict single image
    imagePath = 'data/data_example/foto6.png'

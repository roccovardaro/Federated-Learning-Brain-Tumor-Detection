...
from utils.dataset import load_data_with_validation


class ClientFL(fl.client.NumPyClient):
    def __init__(self, train_data, val_data, test_data, client_id):
        self.model = create_modelCNN()  # Il modello è definito localmente
...
def main(dataset_dir, id_client):
    ...
    train_set, val_set, test_set = load_data_with_validation(dataset_dir=dataset_dir, img_height=img_height,
